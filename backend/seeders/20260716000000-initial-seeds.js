...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    const roles = [
      ...
      { id: '33333333-3333-3333-3333-333333333333', role_name: 'Theatre Owner', createdAt: new Date(), updatedAt: new Date() },
      { id: '44444444-4444-4444-4444-444444444444', role_name: 'Event Organizer', createdAt: new Date(), updatedAt: new Date() }
    ];
